  ...
  return (
    <div className="content-wrapper" title="Globalno poravnanje">
      <p>
        ...
        naziva se <b>homeodomen</b>. Na sledećoj slici možemo videti prikazane homeodomene čoveka i
        miša:
      </p>
      <div className="image">
      ...
      <p>
        ...
        puta. Pokušaćemo da pronađemo efikasniji način. Zamislimo besplatnu vožnju od početnog čvora
        u grafu poravnanja do čvora koji označava početak konzerviranog intervala, i takođe
        zamislimo besplatnu vožnju od čvora koji označava kraj konzerviranog intervala i krajnjeg
        čvora u grafu poravnanja:
      </p>
      <div className="image">
      ...
      <p>
        ...
        relaciju za izračunavanje vrednosti{' '}
        <i>
          S<sub>i,j</sub>
        </i>{' '}
        i sada umesto 3 imamo 4 ulazne grane u čvor <i>(i, j)</i>:
      </p>
      <div className="image">
      ...
      <p>
        ...
        čvora. Pošto postoje grane od svakog do krajnjeg čvora,{' '}
        <i>
          S<sub>i,j</sub>
        </i>{' '}
        možemo izračunati kao maksimum po svim ostalim{' '}
        <i>
          S<sub>i,j</sub>
        </i>{' '}
        :
